...
import type { TokenBalance } from './interfaces/swaps';
import type { Id } from './interfaces/token';
...
declare module '@polkadot/api/types/events' {
  export interface AugmentedEvents<ApiType> {
    ...
    swaps: {
       ...
       **/
      CurrencyPurchase: AugmentedEvent<ApiType, []>;
      /**
       * Logs (SetIndex, x, x, x)
       **/
      LiquidityAdded: AugmentedEvent<ApiType, [Id, AccountId, BalanceOf, TokenBalance]>;
      /**
       * Logs (SetIndex, x, x, x)
       **/
      LiquidityRemoved: AugmentedEvent<ApiType, [Id, AccountId, BalanceOf, TokenBalance]>;
      /**
       * Logs (SetIndex, SwapAccount)
       **/
      SwapCreated: AugmentedEvent<ApiType, [Id, AccountId]>;
      /**
       * Logs (SetIndex, buyer, currency_sold, tokens_bought, recipient)
       **/
      TokenPurchase: AugmentedEvent<ApiType, []>;
    };
    system: {
      [key: string]: AugmentedEvent<ApiType>;
      /**
    ...
    token: {
       ...
       **/
      Approval: AugmentedEvent<ApiType, [AccountId, AccountId, Balance]>;
      NewToken: AugmentedEvent<ApiType, [AssetId, AccountId, Balance]>;
      /**
       * <from, to, amount>
       **/
      Transfer: AugmentedEvent<ApiType, [AccountId, AccountId, Balance]>;
