...
import type { Swap, TokenDossier } from './interfaces/swaps';
...
import type { SetIndex, VoteThreshold } from '@polkadot/types/interfaces/elections';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    fungibleAssets: {
       ...
       * Allowance
       **/
      allowances: AugmentedQueryDoubleMap<ApiType, (key1: AssetId | AnyNumber | Uint8Array, key2: ITuple<[AccountId, AccountId]> | [AccountId | string | Uint8Array, AccountId | string | Uint8Array]) => Observable<Balance>, [AssetId, ITuple<[AccountId, AccountId]>]> & QueryableStorageEntry<ApiType, [AssetId, ITuple<[AccountId, AccountId]>]>;
      /**
       * The number of units of assets held by any given account.
       **/
      balances: AugmentedQueryDoubleMap<ApiType, (key1: AssetId | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Balance>, [AssetId, AccountId]> & QueryableStorageEntry<ApiType, [AssetId, AccountId]>;
      /**
       * The next asset identifier up for grabs.
       **/
      nextAssetId: AugmentedQuery<ApiType, () => Observable<AssetId>, []> & QueryableStorageEntry<ApiType, []>;
      tokenInfo: AugmentedQuery<ApiType, (arg: AssetId | AnyNumber | Uint8Array) => Observable<Option<TokenDossier>>, [AssetId]> & QueryableStorageEntry<ApiType, [AssetId]>;
      /**
       * The total unit supply of an asset.
       * 
       * TWOX-NOTE: `AssetId` is trusted, so this is safe.
       **/
      totalSupply: AugmentedQuery<ApiType, (arg: AssetId | AnyNumber | Uint8Array) => Observable<Balance>, [AssetId]> & QueryableStorageEntry<ApiType, [AssetId]>;
    };
    grandpa: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
    ...
    swaps: {
      [key: string]: QueryableStorageEntry<ApiType>;
      swapCount: AugmentedQuery<ApiType, () => Observable<SetIndex>, []> & QueryableStorageEntry<ApiType, []>;
      swapsHouse: AugmentedQuery<ApiType, (arg: SetIndex | AnyNumber | Uint8Array) => Observable<Option<Swap>>, [SetIndex]> & QueryableStorageEntry<ApiType, [SetIndex]>;
      tokenToSwap: AugmentedQuery<ApiType, (arg: AssetId | AnyNumber | Uint8Array) => Observable<SetIndex>, [AssetId]> & QueryableStorageEntry<ApiType, [AssetId]>;
    };
    system: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
    ...
    token: {
       ...
       * /// Allowance
       **/
      allowance: AugmentedQueryDoubleMap<ApiType, (key1: AssetId | AnyNumber | Uint8Array, key2: ITuple<[AccountId, AccountId]> | [AccountId | string | Uint8Array, AccountId | string | Uint8Array]) => Observable<Balance>, [AssetId, ITuple<[AccountId, AccountId]>]> & QueryableStorageEntry<ApiType, [AssetId, ITuple<[AccountId, AccountId]>]>;
      balances: AugmentedQueryDoubleMap<ApiType, (key1: AssetId | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Balance>, [AssetId, AccountId]> & QueryableStorageEntry<ApiType, [AssetId, AccountId]>;
      tokenCount: AugmentedQuery<ApiType, () => Observable<AssetId>, []> & QueryableStorageEntry<ApiType, []>;
      totalSupply: AugmentedQuery<ApiType, (arg: AssetId | AnyNumber | Uint8Array) => Observable<Balance>, [AssetId]> & QueryableStorageEntry<ApiType, [AssetId]>;
    };
    transactionPayment: {
      [key: string]: QueryableStorageEntry<ApiType>;
