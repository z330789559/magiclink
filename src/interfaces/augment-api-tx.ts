...
import type { DefunctVoter, Renouncing, SetIndex } from '@polkadot/types/interfaces/elections';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    fungibleAssets: {
       ...
       * # </weight>
       **/
      transfer: AugmentedSubmittable<(id: Compact<AssetId> | AnyNumber | Uint8Array, target: AccountId | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<AssetId>, AccountId, Compact<Balance>]>;
    };
    grandpa: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    swaps: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      addLiquidity: AugmentedSubmittable<(swapId: SetIndex | AnyNumber | Uint8Array, currencyAmount: BalanceOf | AnyNumber | Uint8Array, minLiquidity: Balance | AnyNumber | Uint8Array, maxTokens: Balance | AnyNumber | Uint8Array, deadline: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [SetIndex, BalanceOf, Balance, Balance, BlockNumber]>;
      createSwap: AugmentedSubmittable<(tokenId: AssetId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId]>;
      /**
       ...
       **/
      currencyToTokensInput: AugmentedSubmittable<(swapId: SetIndex | AnyNumber | Uint8Array, currency: BalanceOf | AnyNumber | Uint8Array, minTokens: Balance | AnyNumber | Uint8Array, deadline: BlockNumber | AnyNumber | Uint8Array, recipient: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [SetIndex, BalanceOf, Balance, BlockNumber, AccountId]>;
      /**
       * Converts currency to tokens.
       * 
       ...
       * tokens to be returned.
       **/
      currencyToTokensOutput: AugmentedSubmittable<(swapId: SetIndex | AnyNumber | Uint8Array, tokensBought: Balance | AnyNumber | Uint8Array, maxCurrency: BalanceOf | AnyNumber | Uint8Array, deadline: BlockNumber | AnyNumber | Uint8Array, recipient: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [SetIndex, Balance, BalanceOf, BlockNumber, AccountId]>;
      removeLiquidity: AugmentedSubmittable<(swapId: SetIndex | AnyNumber | Uint8Array, sharesToBurn: Balance | AnyNumber | Uint8Array, minCurrency: BalanceOf | AnyNumber | Uint8Array, minTokens: Balance | AnyNumber | Uint8Array, deadline: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [SetIndex, Balance, BalanceOf, Balance, BlockNumber]>;
      /**
       ...
       **/
      tokensToCurrencyInput: AugmentedSubmittable<(swapId: SetIndex | AnyNumber | Uint8Array, tokensSold: Balance | AnyNumber | Uint8Array, minCurrency: BalanceOf | AnyNumber | Uint8Array, deadline: BlockNumber | AnyNumber | Uint8Array, recipient: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [SetIndex, Balance, BalanceOf, BlockNumber, AccountId]>;
      /**
       * Converts tokens to currency.
       * 
       ...
       **/
      tokensToCurrencyOutput: AugmentedSubmittable<(swapId: SetIndex | AnyNumber | Uint8Array, currencyBought: BalanceOf | AnyNumber | Uint8Array, maxTokens: Balance | AnyNumber | Uint8Array, deadline: BlockNumber | AnyNumber | Uint8Array, recipient: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [SetIndex, BalanceOf, Balance, BlockNumber, AccountId]>;
    };
    system: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    token: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      approve: AugmentedSubmittable<(id: AssetId | AnyNumber | Uint8Array, spender: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, LookupSource, Compact<Balance>]>;
      debugBurn: AugmentedSubmittable<(id: AssetId | AnyNumber | Uint8Array, from: AccountId | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, AccountId, Balance]>;
      debugCreateToken: AugmentedSubmittable<(totalSupply: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<Balance>]>;
      debugMint: AugmentedSubmittable<(id: AssetId | AnyNumber | Uint8Array, to: AccountId | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, AccountId, Balance]>;
      transfer: AugmentedSubmittable<(id: AssetId | AnyNumber | Uint8Array, destination: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, LookupSource, Compact<Balance>]>;
      transferFrom: AugmentedSubmittable<(id: AssetId | AnyNumber | Uint8Array, from: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, to: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, LookupSource, LookupSource, Compact<Balance>]>;
    };
    treasury: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
