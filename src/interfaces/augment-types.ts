...
import type { Swap, TokenBalance, TokenDossier, setIndex } from './interfaces/swaps';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<TokenDossier>': Option<TokenDossier>;
    ...
    'Vec<TokenDossier>': Vec<TokenDossier>;
